...
- 📅 **週間プランナー** - タスクを曜日ごとに整理、ドラッグ＆ドロップで簡単管理
...
タスクを曜日（月〜金）に振り分けて1週間の計画を立てられます。

- **ドラッグ＆ドロップ**: タスクを曜日間で自由に移動
- **未割り当てエリア**: 曜日を解除したいタスクはここにドロップ
- **プロジェクト表示**: 各タスクにプロジェクト名・エピック名も表示
