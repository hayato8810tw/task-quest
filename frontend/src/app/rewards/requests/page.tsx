...
export default function RewardRequestsPage() {
    ...
    const fetchRedemptions = async () => {
        ...
        try {
            const res = await fetch(`http://localhost:3001/api/rewards/admin/redemptions`, {
    ...
    const handleApprove = async (id: string) => {
        ...
        setProcessing(id);
        try {
            const res = await fetch(`http://localhost:3001/api/rewards/redemptions/${id}/approve`, {
                method: "PATCH",
                headers: { Authorization: `Bearer ${token}` },
            });
            const data = await res.json();
    ...
    const handleReject = async (id: string) => {
        ...
        setProcessing(id);
        try {
            const res = await fetch(`http://localhost:3001/api/rewards/redemptions/${id}/reject`, {
                method: "PATCH",
                headers: { Authorization: `Bearer ${token}` },
            });
            const data = await res.json();
